...
import 'package:flutter_ecommerce_ui/circlepainters/circlepainters.dart';
import 'package:flutter_ecommerce_ui/models/product.dart';
import 'package:flutter_ecommerce_ui/screens/product_list.dart';
import 'package:flutter_ecommerce_ui/screens/search.dart';
import 'package:flutter_ecommerce_ui/screens/shoppingcart.dart';
import 'package:flutter_ecommerce_ui/screens/whell.dart';
import 'package:flutter_ecommerce_ui/utils/constant.dart';
import 'package:flutter_ecommerce_ui/utils/navigator.dart';
import 'package:flutter_ecommerce_ui/widgets/item_product.dart';
import 'package:flutter_ecommerce_ui/widgets/occasions.dart';
            ...
            children: <Widget>[
              ...
              TrendingItem(
                product: Product(
                    ...
                    rating: 4.5,
                    price: '\$3,890', remainingQuantity: 2),
                gradientColors: [Color(0XFF6eed8c), Colors.green.shade500],
              ),
              TrendingItem(
                product: Product(
                    company: 'Xiaomi',
                    ...
                    icon: 'assets/mi1.png',
                    rating: 3.5,
                    price: '\$2,890', remainingQuantity: 4),
              ...
              TrendingItem(
                product: Product(
                    ...
                    icon: 'assets/phone2.jpeg',
                    rating: 4.5,
                    price: '\$3,890', remainingQuantity: 6),
              ...
              TrendingItem(
                product: Product(
                    ...
                    icon: 'assets/mi1.png',
                    rating: 3.5,
                    price: '\$2,890', remainingQuantity: 6),
                gradientColors: [Color(0XFFf28767), Colors.orange.shade400],
              ),
              TrendingItem(
                product: Product(
              ...
              TrendingItem(
                product: Product(
                    ...
                    icon: 'assets/phone2.jpeg',
                    rating: 4.5,
                    price: '\$3,890', remainingQuantity: 10),
                gradientColors: [Color(0XFF6eed8c), Colors.green.shade400],
              ),
              TrendingItem(
                product: Product(
                    ...
                    icon: 'assets/mi1.png',
                    rating: 3.5,
                    price: '\$2,890', remainingQuantity: 2),
                gradientColors: [Color(0XFFf28767), Colors.orange.shade400],
              ),
            ],
          ),
          ...
          ListTile(
            ...
            title: Text('My Orders',
                style: TextStyle(
                    ...
                    color: blackColor)),
            onTap: () {
              Nav.route(context, ProductList(product: null,));
            },
          ),
          ListTile(
...
class CategoriesListView extends StatelessWidget {
  ...
  const CategoriesListView({required Key key,
    required this.title,
